...
Benchmark.bmbm do |results|
  ...
  results.report("Fast ''") { TESTS.times { Fenix::File.expand_path_fast('') } }
  ...
  results.report("Fast 'foo', 'bar'") { TESTS.times { Fenix::File.expand_path_fast('foo', 'bar') } }

  results.report("Ruby '', 'C:/'") { TESTS.times {  File.expand_path('', 'C:/') } }
  results.report("Fenix '', 'C:/'") { TESTS.times { Fenix::File.expand_path('', 'C:/') } }
  results.report("Fast '', 'C:/'") { TESTS.times { Fenix::File.expand_path_fast('', 'C:/') } }
  ...
  results.report("Fast 'foo', 'C:/'") { TESTS.times { Fenix::File.expand_path_fast('foo', 'C:/') } }
  ...
  if ENV["SLOW"]
    ...
    results.report("Fast 'D:/Bar', 'C:/Foo'") { TESTS.times { Fenix::File.expand_path_fast('D:/Bar', 'C:/Foo') } }
  end
  ...
  results.report("Fast '~/foo'") { TESTS.times { Fenix::File.expand_path_fast('~/foo') } }
  ...
  results.report("Fast '~', 'C:/Foo'") { TESTS.times { Fenix::File.expand_path_fast('~', 'C:/Foo') } }
  ...
  results.report("Fast long_path") { TESTS.times { Fenix::File.expand_path_fast(long_path) } }
  ...
  results.report("Fast long_path, 'rel'") { TESTS.times { Fenix::File.expand_path_fast(long_path, 'rel') } }
  ...
  results.report("Fast long_path, 'C:/Foo'") { TESTS.times { Fenix::File.expand_path_fast(long_path, 'C:/Foo') } }
  ...
  results.report("Fast full_long_path") { TESTS.times { Fenix::File.expand_path_fast(full_long_path) } }
  ...
  results.report("Fast to_path") { TESTS.times { Fenix::File.expand_path_fast(to_path) } }
  ...
  results.report("Fast to_path, 'rel'") { TESTS.times { Fenix::File.expand_path_fast(to_path, 'rel') } }
  ...
  results.report("Fast to_path, 'C:/Foo'") { TESTS.times { Fenix::File.expand_path_fast(to_path, 'C:/Foo') } }
  ...
  results.report("Fast full_to_path") { TESTS.times { Fenix::File.expand_path_fast(full_to_path) } }
end
